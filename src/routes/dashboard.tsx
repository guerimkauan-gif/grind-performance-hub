      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 16px", height: 52, borderBottom: "1px solid #1A1A24", flexShrink: 0 }}>
          ...
          <button
            ...
            title="Novo chat"
            style={{ background: "transparent", border: "1px solid #1A1A24", color: "#A0A0A0", width: 28, height: 28, fontSize: 18, lineHeight: "24px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}
            ...
            onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.color = "#A0A0A0"; (e.currentTarget as HTMLButtonElement).style.borderColor = "#1A1A24"; }}
          >+</button>
        </div>
          ...
          {conversations.length === 0 ? (
            ...
            groupConversations(conversations).map((group) => (
              <div key={group.label} style={{ marginBottom: 12 }}>
                <div style={{ padding: "8px 12px 6px 16px", fontSize: 10, color: "#444", textTransform: "uppercase", letterSpacing: "0.18em", fontFamily: "'Space Grotesk', sans-serif" }}>
                  {group.label}
                </div>
                {group.items.map((c) => {
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={(e) => { if (!isActive && !isConfirming) (e.currentTarget as HTMLDivElement).style.background = "#13131A"; }}
                    ...
                    >
                      {isConfirming ? (
                        ...
                        <>
                          <div style={{ flex: 1, minWidth: 0, fontSize: 13, color: isActive ? "#FFFFFF" : "#CCCCCC", fontFamily: "'Space Grotesk', sans-serif", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {c.title}
                          </div>
                          <div style={{ fontSize: 11, color: "#555", fontFamily: "'JetBrains Mono', monospace", flexShrink: 0 }}>
